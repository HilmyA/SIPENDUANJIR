...
$sql = $koneksi->query("SELECT COUNT(id_rt) as rt  from tb_rt");
while ($data = $sql->fetch_assoc()) {
	$rt = $data['rt'];
}
...
<div class="row">
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-warning">
			...
			<a href="index.php?page=data-rt" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-red">
			...
			<a href="index.php?page=filter-lk" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-red">
			...
			<a href="index.php?page=filter-pr" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
