			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<select name="pendidikan" id="pendidikan" class="form-control">
						<option>- Pilih -</option>
						<option>Tidak/Berhenti Sekolah</option>
						<option>TK</option>
						<option>SD</option>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_pdd (nik, nama, tempat_lh, tgl_lh, jekel, desa, rt, rw, agama, kawin, pekerjaan, pendidikan, status) VALUES (
            '".$_POST['nik']."',
            '".$_POST['nama']."',
			'".$_POST['tempat_lh']."',
			'".$_POST['tgl_lh']."',
